...
**Persistence:** `raw_observations` (append-only, retention-tiered)
...
**Owned by:** intelligence repo
**Persistence:** `normalized_observations`
...
**Owned by:** intelligence repo
**Persistence:** `derived_features` (with input lineage back to normalized observations)
...
**Owned by:** intelligence repo
**Persistence:** `normalized_observations` with contextual signal class
